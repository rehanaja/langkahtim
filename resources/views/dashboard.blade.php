...
@section('content')
    ...
    <div class="row my-4">
        <div class="col-lg-12 col-md-6 mb-md-0 mb-4 overflow-hidden">
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Subcription</th>
